...
def init(config, directory, template="generic", package=False):
    ...
    :param package: when True, write ``app_main.py`` files into the
    ...
    if package:
        for path in [
            os.path.join(os.path.abspath(directory), "app_main.py"),
            os.path.join(os.path.abspath(versions), "app_main.py"),
        ]:
